...
const About = () => {
  return (
    <>
      ...
      >
        I'm a skilled Software Engineer with expertise in .NET, Java, and
        JavaScript technologies. Proven experience in microservices architecture
        and REST API development. Contributed to performance improvements
        through gRPC implementation. Familiar with CI/CD concepts and cloud
